...
Revision ID: 2774394def5c
Revises: 
Create Date: 2025-12-17 11:16:12.522215
...
def upgrade() -> None:
    ...
    sa.Column('additional_info', sa.String(length=551), nullable=False),
    ...
    sa.Column('temparature', sa.Float(), nullable=False),
